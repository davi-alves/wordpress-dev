 ...
 * @link       null
 */
class Flyingkrai_FeaturedSlider
{
    ...
    public function init()
    {
        ...
        //- class helpers
        self::$_mustache = Flyingkrai_Helpers_Mustache::get_instance();
        ...
        //- init classes
        new Flyingkrai_FeaturedSlider_ConfigPage(self::$_instance, self::$_mustache);
    }
