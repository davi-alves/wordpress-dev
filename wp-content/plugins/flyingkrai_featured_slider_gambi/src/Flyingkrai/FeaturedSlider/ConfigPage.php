 ...
 * @link       null
 */
class Flyingkrai_FeaturedSlider_ConfigPage
{
     ...
     */
    public function __construct(Flyingkrai_FeaturedSlider $featuredSlider, Flyingkrai_Helpers_Mustache $mustache)
    {
        //- main class instance
    ...
    public function admin_scripts()
    {
        ...
        wp_enqueue_script(
            ...
            Flyingkrai_FeaturedSlider::VERSION
        );
    ...
    public function add_admin_page()
    {
        ...
        add_menu_page(
            $this->get_menu_title(),
            Flyingkrai_FeaturedSlider::DISPLAY_NAME,
            'manage_options',
    ...
    {
        return Flyingkrai_FeaturedSlider::PLUGIN_NAMESPACE . '_admin_page';
    }
    ...
    {
        return Flyingkrai_FeaturedSlider::DISPLAY_NAME . ' - Gerência';
    }
    ...
    {
        return Flyingkrai_FeaturedSlider::PLUGIN_NAMESPACE . '_nonce';
    }

    protected function get_admin_form_nonce_field()
    {
        return Flyingkrai_FeaturedSlider::PLUGIN_NAMESPACE . '_field';
    }

    protected function get_admin_script_id()
    {
        return Flyingkrai_FeaturedSlider::PLUGIN_NAMESPACE . '_ajax';
    }
}
